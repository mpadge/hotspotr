...
// [[Rcpp::export]]
Rcpp::NumericMatrix rcpp_ives2D_separate (int size, int nt, 
        double alpha_t, double alpha_s,
        Rcpp::NumericVector svec, Rcpp::NumericVector rvec)
{
    // Modified from ives2D to implement entirely separate temporal and spatial
    // autocorrelation
    int indx;
    const double s0 = 0.5, r0 = 1.05, a0 = 0.05;
    double s, r;
